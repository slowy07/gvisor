...
func (e *endpoint) Close() {
	...
	case transport.DatagramEndpointStateBound, transport.DatagramEndpointStateConnected:
		...
		e.stack.UnregisterTransportEndpoint([]tcpip.NetworkProtocolNumber{e.netProto}, e.transProto, id, e, ports.Flags{}, e.boundBindToDevice)
	default:
...
func (e *endpoint) Connect(addr tcpip.FullAddress) tcpip.Error {
	...
	err := e.net.ConnectAndThen(addr, func(netProto tcpip.NetworkProtocolNumber, previousID, nextID stack.TransportEndpointID) tcpip.Error {
		...
		if e.ident != 0 {
			...
			e.stack.UnregisterTransportEndpoint([]tcpip.NetworkProtocolNumber{e.netProto}, e.transProto, previousID, e, ports.Flags{}, e.boundBindToDevice)
		}
...
func (e *endpoint) Bind(addr tcpip.FullAddress) tcpip.Error {
	if len(addr.Addr) != 0 && e.isBroadcastOrMulticast(addr.NIC, e.netProto, addr.Addr) {
